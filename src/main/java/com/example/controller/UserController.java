...
public class UserController {
	...
	public String main(Model model) {
		...
		model.addAttribute("address", "경기도 의정부시 범골로");
	...
	public String register2(@RequestParam("userid") String userid, @RequestParam("passwd") String passwd,
			@RequestParam("username") String username, @RequestParam("userage") int age,
			@RequestParam("gender") String gender, Model model) {
	...
	public String register4(@PathVariable String userid, 
